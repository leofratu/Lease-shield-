...
Donate link: https://card2crypto.org
...
Minimum allowed order amount varies per payment provider you can [check the full list of minimum order value per payment provider](https://Card2Crypto.org/instant-payment-gateway/#minimumorder).

The plugin and offered service through [PayGate.to Instant Payment Gateway API](https://Card2Crypto.org/instant-payment-gateway/) is subject to the [service terms](https://Card2Crypto.org/info/terms/) and [Privacy Policy](https://Card2Crypto.org/info/privacy-policy/).
...
Follow the guide to [Fix WooCommerce There Are No Payment Methods Available Error](https://Card2Crypto.org/fix-woocommerce-there-are-no-payment-methods-available-error/)
...
Our plugin is tested to mark orders as processing automatically after payment. You can follow our [guide for fixing common payment gateway issues](https://Card2Crypto.org/woocommerce-payment-gateway-troubleshooting/).

= Are there any restricted businesses? =

Anyone can use our payment plugin instantly without providing any information. However if your website category falls under our [prohibited business list](https://Card2Crypto.org/instant-payment-gateway/#prohibited) your domain will be blocked.
